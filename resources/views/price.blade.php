    ...
    <div id="price">
        <div class="main_container">
            <div class="price_title">
                ...
                <p>У нас прозрачная и конкурентоспособная система ценообразования, которая предоставляет вам доступ к высококачественным услугам по суррогатному материнству в Казахстане. Мы предлагаем гибкие пакеты услуг, а также индивидуальные варианты, чтобы удовлетворить ваши уникальные потребности.</p>
            </div>

            <div class="price_services">
                <div class="price_services_title">
                    <h3 class="price_services_left">Наименование услуги</h3>
                    <h3 class="price_services_right">Сумма в тенге</h3>
                </div>
