...
@section('content')
    ...
    <div class="main_container">
        <ul class="link_path">
            ...
            <li>
                <a href="#">requirements for surrogate mothers</a>
            </li>
        </ul>
    ...
    <section id="questionnaire">
        ...
        <div class="analyzes">
            ...
            <div class="wrapper_container">
                <h2>For the surrogate mother, initial tests and certificates:</h2>
                ...
                <div class="application_right partenrsBlock">
                    ...
                    <div class="application_btns">
                        <a href="{{'https://'.setting('kontakty.email')}}" target="_blank">
                            <img src="{{asset("./images/application_main2.svg")}}" alt="">
                        </a>
                        <a href="{{'https://'.setting('kontakty.wa')}}" target="_blank">
                            <img src="{{asset("./images/application_whatsapp2.svg")}}" alt="">
                        </a>
                        <a href="{{'https://'.setting('kontakty.tg')}}" target="_blank">
                            <img src="{{asset("./images/application_telegram2.svg")}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
