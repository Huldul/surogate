...
@section('content')
    ...
    <div class="main_container">
        <ul class="link_path">
            ...
            <li>
                <span>price list for citizens of the Russian Federation</span>
            </li>
        </ul>
    </div>
    <!-- link_path -->
    ...
    <div id="price">
        <div class="main_container">
            <div class="price_title">
                ...
                <h1 class="main_title">price list for citizens of the Russian Federation</h1>
                <p>
