...
{{-- @section('title')@else{{$seo->metatitleabout}}@endsection
@section('description'){{$indexPage->metadescriptionabout}}@endsection
@section('keywords'){{$indexPage->metakeyabout}}@endsection --}}
...
@section('content')
    ...
    <section id="about">
        ...
        <img class="about_effekt_img" src="{{asset("./images/about_effekt_img.svg")}}" alt="">
    </section>
